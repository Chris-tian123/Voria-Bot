### Welcome to the Mod Bot, a Discord moderation bot built using the Sapphire Framework. This bot supports traditional prefix commands, along with powerful moderation tools and custom features.
